...
class DisciplineFilterBar extends StatelessWidget {
      ...
      children: [
        Expanded(
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Поиск дисциплины или преподавателя',
        ...
        DropdownButton<String>(
          ...
          items: const [
            ...
            DropdownMenuItem(value: 'teacher', child: Text('Сортировка: Преподаватель')),
          ],
